...
use Application\Model\Tag\TagDb;
...
# recuperation des cinq dernier article de la bdd
...
#recueration des articles en position special
...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="<?= PATH_PUBLIC ?><?= PATH_PUBLIC ?>/images/favicon.png">
